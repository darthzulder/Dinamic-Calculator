...
class Preferences(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_MAX_SCIENTIFIC_NOTATION_DIGITS =
                "marktka.calculatorYou.MAX_SCIENTIFIC_NOTATION_DIGITS"
        private const val KEY_GROUPING_SEPARATOR_SYMBOL =
                "marktka.calculatorYou.GROUPING_SEPARATOR_SYMBOL"
        private const val KEY_DECIMAL_SEPARATOR_SYMBOL =
                "marktka.calculatorYou.DECIMAL_SEPARATOR_SYMBOL"
        ...
        private const val KEY_SWIPE_DIGITS_AND_SCIENTIFIC_FUNCTIONS =
                "marktka.calculatorYou.SWIPE_DIGITS_AND_SCIENTIFIC_FUNCTIONS"
    ...
    fun getDynamicColor(): Boolean {
        ...
        else preferences.getBoolean(KEY_DYNAMIC_COLORS, false)
    }
    ...
    fun getNumberPrecision(): Int {
        return preferences.getInt(KEY_NUMBER_PRECISION, 2)
    }
